			...
			<div className={styles.bottomSide}>
				<div className={styles.featureItem}>
					<div className={styles.icon}>
						<img src='./assets/tape/feature/photo.png' alt='photo' />
					</div>
					<div className={styles.text}>Photo</div>
				</div>
				<div className={styles.featureItem}>
					<div className={styles.icon}>
						<img src='./assets/tape/feature/video.png' alt='video' />
					</div>
					<div className={styles.text}>Vidieos</div>
				</div>
				<div className={styles.featureItem}>
					<div className={styles.icon}>
						<img src='./assets/tape/feature/working.png' alt='working' />
					</div>
					<div className={styles.text}>Working</div>
				</div>
				<div className={styles.featureItem}>
					<div className={styles.icon}>
						<img src='./assets/tape/feature/article.png' alt='article' />
					</div>
